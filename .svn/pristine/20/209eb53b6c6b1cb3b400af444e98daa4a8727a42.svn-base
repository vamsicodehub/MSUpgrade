...
import com.aurionpro.beneficiary.basevalueobject.MakerCheckerBO;
import com.aurionpro.beneficiary.basevalueobject.MasterBO;
...
public class MakerCheckerDetailsAssembler extends BaseDetailsAssembler {
	 ...
	 */
	@Override
	public MakerCheckerBO assemble(BaseBO bo, BaseDetails details)
			throws BaseException, RemoteException {
		// TODO Auto-generated method stub
		BaseBO baseAssemble = super.assemble(bo, details);		

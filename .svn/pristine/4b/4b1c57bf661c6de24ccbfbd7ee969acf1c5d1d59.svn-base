...
abstract public class AbstractFieldValidator {

	/** The next field validator. */
	protected AbstractFieldValidator nextFieldValidator;

	/**
	 * Sets the next validator.
	 *
	 * @param fieldValidator the new next validator
	 */
	public void setNextValidator(AbstractFieldValidator fieldValidator) {
		this.nextFieldValidator = fieldValidator;
	}
	 ...
	 * @return the list
	 */
	public abstract List<String> validate(Object obj);
}
